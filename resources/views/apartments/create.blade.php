        ...
        <div class="col-10">
            <form id="formEl" action="{{ route('apartments.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group p-2">
                    ...
                    <input type="number" class="form-control" style="width: 7%"  name="surface" id="surface" value="{{ old('surface') }}">
                    <div class="error"></div>
                    @error('surface')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-group p-2">
                    ...
                    <input type="number" class="me-5" name="n_room" style="width: 5%" id="n_room" value="{{ old('n_room') }}">
                    <div class="error"></div>
                    @error('n_room')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                    ...
                    <input type="number" class="me-5" style="width: 5%" name="n_bed" id="n_bed" value="{{ old('n_bed') }}">
                    <div class="error"></div>
                    @error('n_bed')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-group p-2">
                    ...
                    <input type="price" style="width: 6%"  name="price" id="price" value="{{ old('price') }}">
                    &#8364;
                    <div class="error"></div>
                    @error('price')
                        <div class="alert alert-danger">{{ $message }}</div>
